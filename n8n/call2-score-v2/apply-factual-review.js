...
const previousReviewCosts=null;
...
return [{json:{__factual_review_retry_required:false,final_result:{...result,automatic_retry:original.automatic_retry,factual_review:{revision:'factual-editor-2026-09-10',status:applied.verdict,changed_paths:applied.changedPaths,review_cost_usd:Number(provider.costs?.total_cost_usd||0)}}}}];
