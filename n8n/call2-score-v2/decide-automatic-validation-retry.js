...
const retryablePattern = /^(provider_unparseable_json|missing_coaching_field:|missing_manager_score$|missing_score_review$|missing_dimension_review:|invalid_close_signal:|missing_dimension:|ungrounded_dimension_evidence:|invalid_confidence$|invalid_not_applicable:|invalid_band:|insufficient_applicable_weight$)/;
