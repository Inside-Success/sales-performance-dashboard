...
const source = $('Prepare V6 JSON Repair').item.json;
...
const reviewTargets = {
  ...
  risky_criteria: riskyCriteria,
};
const reviewSystem = [
  'You are the selective evidence verifier for Magic Mike V6.2.',
  'You are not a second scorer. Review only the listed material risks and decision facts; do not reassess ordinary criteria.',
...
const schema = {
  ...
  criterion_verdicts: [{ dimension_key: 'targeted dimension', criterion_id: 'targeted criterion', corroborated: false, corrected_status: 'met|partial|missed|harmful|not_applicable|not_observable', reason: 'brief factual reason', evidence: [{ timestamp: 'exact', speaker: 'exact', quote: 'exact' }] }],
