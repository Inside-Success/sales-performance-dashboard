      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-5 px-5 pb-16 pt-8 sm:px-8">
        <header className="magic-card magic-hero p-5 md:p-7">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 max-w-2xl text-[15px] font-medium leading-7 text-slate-600">See every closer&apos;s call-execution score in one place. The list is sorted from lowest to highest so you can quickly decide who to review first.</p>
          </div>
        </header>
        ...
        <CloserScorecardTable reps={data.repSummaries} />
