  ...
  try {
    ...
    return Response.json({
      ...
      instructions: [
        ...
        "Use wrong_policy_retrieved only when the runtime selected a policy that is not the same exact decision.",
        "Use missing_repeated_knowledge only for a reusable sales question that has appeared repeatedly without an official answer; a one-off account question is non_faq.",
        "Use correct_safe_route with looks_correct when the bot appropriately refused to invent an unsupported answer.",
